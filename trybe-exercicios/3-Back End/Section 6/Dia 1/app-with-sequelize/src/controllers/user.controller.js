...
const getAll = async (_req, res) => {
  try {
    ...
    res.status(error500).json({ message: errorMessage.error500 });
  }
};
...
const getByIdAndEmail = async (req, res) => {
  try {
    ...
    console.log(e.message);
    res.status(500).json({ message: errorMessage.error500 });
  }
};
...
const deleteUser = async (req, res) => {
  try {
    ...
    console.log(e.message);
    res.status(500).json({ message: errorMessage.error500e });
  }
};
